...
import { FaCode, FaDesktop, FaServer, FaMobile } from 'react-icons/fa';
  ...
  return (
    <ServiceDetailContainer ref={sectionRef}>
      <ServiceHeader ref={titleRef}>
        ...
        <ServiceSubtitle>
          Solusi Web Profesional untuk Transformasi Digital Anda
        </ServiceSubtitle>
      </ServiceHeader>
          ...
          {[
            {
              ...
              description: 'Situs web yang tampil sempurna di semua perangkat, dari desktop hingga mobile.'
            },
            {
              icon: <FaCode size={35} />,
              title: 'Pengembangan Modern',
              description: 'Menggunakan teknologi terkini untuk menciptakan situs web yang cepat dan canggih.'
            },
            {
              icon: <FaServer size={35} />,
              title: 'Optimasi Performa',
              description: 'Situs web dengan kecepatan muat tinggi dan kinerja optimal.'
            },
            {
              icon: <FaMobile size={35} />,
              title: 'Mobile-Friendly',
              description: 'Desain yang sepenuhnya responsif dan ramah perangkat mobile.'
            }
          ].map((feature, index) => (
